...
Энэхүү програм нь AI-д суурилсан CV шалгах платформ бөгөөд ажил горилогчдыг ажлын байрны шаардлагатай нийцүүлэх процессыг автоматжуулах, сайжруулахад зориулагдсан. Систем нь дараах гол боломжуудыг агуулна:
...
- LLM ашиглан хэрэгтэй талбаруудыг CV-нээс олборлох
- LLM ашиглан ажил горилогч тус бүрийг ажлын байрны тодорхойлолттой харьцуулан татгалзах эсвэл дараагийн шатанд оруулах шалгаруулалтыг автоматаар хийж, ажил олгогчийн ажлыг хөнгөвчлөх
- Хэрвээ ажил олгогч ажил горилогчын ур чадварыг баталгаажуулах шаардлагатай гэж үзвэл LLM ашиглан ажил горилогч тус бүрт зориулсан ур чадварын тест үүсгэх
...
**1.Frontend (React)**
- CV оруулах хэсэг
- Ажлын байрны URL оруулах хэсэг
- CV-нүүдээ харах боломж
- LLM нь ажил горилогчдыг (дараагийн шатанд оруулах)/татгалзах шийдвэрийг санал болгох

**2.Backend (FastAPI)** 
CV хариуцсан эндпоинтүүд:
- /upload_cv – CV-г локал хавтаст
- /screen – CV болон ажлын байрны similarity оноо тооцох
- /evaluate - Сонгосон CV-г LLM ашиглан үнэлэх
- /generate_test – Ажил горилогчд зориулсан ур чадварын тест үүсгэх
  
LLM интеграц: CV-г задалж шаардлагатай талбаруудыг гаргаж авах, CV үнэлгээ, тест үүсгэх
Structured scoring: Туршлага-0.3 (2 болон түүнээс дээш жил хамааралтай мэргэжилээр ажилласан бол бонус-0.2), боловсрол-0.2, ур чадвар-0.3, сургалт-0.1, шалгалт эсвэл сертификат-0.1 зэрэгт суурилан оноо өгөх
...
- **Text Embedding** – Ажлын байрны тодорхойлолт болон CV-ийг утгын болон бүтцийн ижил төстэй байдлыг хослосон хайбрид аргаар үнэлж, үүн дээрээ суурьлан эрэмбэлэх
- **LLM-д суурилсан CV Parse** – CV-г LLM ашиглан бүтцээр нь задлах, туршлага, боловсрол, ур чадвар, сургалт, шалгалт, сертификат зэрэг талбаруудыг автоматаар олборлох. LLM (жишээ нь OpenAI GPT- gpt-oss-120b) ашиглан дараах мэдээллийг гаргаж авна:
    ...
    -  Сургалт
    -  шалгалт, сертификат
      Гаргаж авсан өгөгдөл нь дараагийн evaluation & recommendation, test generation процесст ашигласан.
- **Structured Feature Scoring** – Туршлага, боловсрол, ур чадвар, сургалт, шалгалт/сертификат дээр суурилсан оноо
- **Hybrid Scoring** – Semantic similarity (60%) + Structured scoring (40%) = нийт оноо 
- **LLM-д суурилсан үнэлгээ** – ажил горилогчийн давуу талууд, сул талууд, нийцэлийг ажлын байранд хэр тохирохоор нь тодорхйолж, дараагийн шатанд оруулах эсвэл татгалзах шаардлагатай эсэхийш санал болгоно.
- **LLM-д суурилсан тест үүсгэх**– ажил горилогч тус бүрийн дурдагдсан чадвар болон давуу тал дээр суурилсан жишиг тест үүсгэнэ.
...
npm run dev
```
Програм эхэлсэн бол доорхи зураг шиг харагдах бөгөөд ажлын URL хаягаа оруулаад, нэр дэвшигчдийг үнэлэх боломжтой.
...
- Гэвч уг хязгаарлалтаас болоод CV-уудыг зөвхөн нэрээр нь харуулах, дараа нь screen товч дархад нийт CV-үүдийн hybrid score-ийг харуулдаг байдлаар шийдсэн.
...
- Эдгээр шалтгаанаас болоод RAG-ийг энэ хувилбарт ашиглаагүй, харин тусдаа жижиг туршилт хийсэн: [RAG туршилт](https://github.com/gbenderiya/cv_screening_rag)
