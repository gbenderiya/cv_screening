...
- Prompt-ийг сайжруулахын тулд дараа нь Kaggle notebook дээр туршилт хийсэн. Яагаад гэвэл Hugging Face-аас inference ашиглан GPT 120B модел татахад сарын inference ашиглалтын хязгаар амархан дуусаад байсан.
...
- Гэвч уг хязгаарлалтаас болоод CV-уудыг зөвхөн нэрээр нь харуулах, дараа нь screen товч дарахад нийт CV-үүдийн hybrid score-ийг харуулдаг байдлаар шийдсэн.
- Мөн ижил шалтгаанаас болж CV бүрийг нэг нэгээр нь Evaluate товчоор үнэлдэг болгосон.
- Үнэлгээтэй хамт жишиг шалгалтыг автоматаар  харуулхаар төлөвлөж байсан боловч хязгаарлалтаас болоод зөвхөн дурын оролцогч дээр Generate Test товч дарснаар шалгалт  үүсгэх боломжтой байдлаар шийдсэн. Хэрвээ ажил олгогч тухайн хүний дурдсан ур чадварт эргэлзэж байвал CV дээр дурдсан чадвараар нь хурдан бөгөөд амархан байдлаар шалгах зорилгоор шалгалтыг нэмэлтээр оруулж өгсөн.
