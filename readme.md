...
---
## Хязгаарлалтууд:
- OpenAI загвар нь хэт том учраас локал компьютер дээр ачаалах боломжгүй байсан тул эхний ээлжинд 7B хэмжээтэй модельг Hugging Face-ээс татаж локалд хөгжүүлэлт хийсэн.
